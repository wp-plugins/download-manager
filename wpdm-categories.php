...
<table cellspacing="0" class="widefat fixed">
    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-8">
                ...
                <td>
                <input type="text" title="copy the code and place it anywhere inside your post or page" value="[wpdm_category id=<?php echo $id; ?> order_field=id order=desc]" readonly=readonly onclick="this.select()"  style="width:180px;font-size: 10px;" />
                </td>
